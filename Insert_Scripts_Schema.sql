-- SELECT and INSERT scripts.
-- select scripts for student, college and apply relation
select * from ashmi_schema.student;
select * from ashmi_schema.college;
select * from ashmi_schema.apply;

-- Insert scripts for college relation
...
-- Insert scripts for student relation
...
-- Insert scripts for apply relation
